             ...
             <div class="col-lg-12">
                <div class="breadcrumbs-content text-center">
                    ...
                    <ul class="breadcrumbs-link">
                       <li><a href="https://itsfolio.com">Home</a></li>
                                ...
                                <div class="social-box">
                                    <ul class="social-link">
                                        @foreach ($user->social_media as $social)
                                            <li> 
                                                <a href="{{ $social->url }}" class="vr-social_media" target="_blank">
                                                        <i class="{{ $social->icon }}"></i>
                                                    </a>
                                            </li>
                                             <!-- @if(strpos($social->icon, "facebook"))
                                                <a href="{{ $social->url }}" class="social_media" target="_blank">
                                                    <img src="{{ asset('assets/front/img/home/footer/facebook.png') }}" class="img-fluid">
                                                </a>
                                                @elseif(strpos($social->icon, "instagram"))
                                                <a href="{{ $social->url }}" class="social_media" target="_blank">
                                                    <img src="{{ asset('assets/front/img/home/footer/instagram.png') }}" class="img-fluid">
                                                </a>
                                                @elseif(strpos($social->icon, "linkedin"))
                                                <a href="{{ $social->url }}" class="social_media" target="_blank">
                                                    <img src="{{ asset('assets/front/img/home/footer/linkedin.png') }}" class="img-fluid">
                                                </a>
                                                @elseif(strpos($social->icon, "twitter"))
                                                    <a href="{{ $social->url }}" class="social_media" target="_blank">
                                                        <img src="{{ asset('assets/front/img/home/footer/twitter.png') }}" class="img-fluid">
                                                    </a>
                                                @else
                                                    <a href="{{ $social->url }}" class="vr-social_media" target="_blank">
                                                        <i class="{{ $social->icon }}"></i>
