...
$domain = env('WEBSITE_HOST', 'itsfolio.com');

if (!app()->runningInConsole()) {
    if (substr($_SERVER['HTTP_HOST'], 0, 4) === 'www.') {
        $domain = 'www.' . env('WEBSITE_HOST', 'itsfolio.com');
    }
}
...
Route::domain($domain)->group(function () {
    ...
    Route::group(['middleware' => 'setlang'], function () {
        ...
        Route::get('/contact', 'Front\FrontendController@contactPage')->name('front.contact');
        Route::get('/test2', 'Front\FrontendController@test2')->name('front.test2');
        Route::get('/test3', 'Front\FrontendController@test3')->name('front.test3');
        ...
        Route::get('/contact2', 'Front\FrontendController@contactView')->name('front.contact2');
    ...
    Route::group(['middleware' => ['web', 'guest', 'setlang']], function () {
        ...
        Route::get('/user/login', 'User\Auth\LoginController@showLoginForm')->name('user.login1');
...
Route::group(['domain' => $domain, 'prefix' => $prefix], function () {
    ...
    // customer end
    Route::get('/{domain?}', 'Front\FrontendController@userDetailView')
