...
if (!function_exists('getParam')) {
    ...
    function getParam()
    {
        ...
        if (strpos($host, env('WEBSITE_HOST', 'itsfolio.com')) !== false && $host == env('WEBSITE_HOST', 'itsfolio.com')) {
...
if (!function_exists('getUser')) {
    ...
    function getUser()
    {
        ...
        if (strpos($host, env('WEBSITE_HOST', 'itsfolio.com')) !== false) {
            $host = str_replace('www.', '', $host);
            // if current URL is a path based URL
            if ($host == env('WEBSITE_HOST', 'itsfolio.com')) {
                $path = explode('/', $parsedUrl['path']);
                $username = $path[1];
            } 
            ...
            if(($host == $username . '.' . env('WEBSITE_HOST', 'itsfolio.com')) || ($host . '/' . $username == env('WEBSITE_HOST', 'itsfolio.com') . '/' . $username)) {
...
if (!function_exists('detailsUrl')) {
    ...
    {
        return '//' . env('WEBSITE_HOST', 'itsfolio.com') . '/' . $user->username;
    }
}
