...
<head>
    <!--====== Required meta tags ======-->
    <meta charset="utf-8">
    <meta name="google-site-verification" content="z6D_kkvRBmqjOp0Gclnv_1QergSok-4eQWikZzJvcXc" />
    <meta http-equiv="x-ua-compatible" content="ie=edge"> 
    
    <meta name="title" content="itsfolio.com: Portfolio Website Builder- Create a Free Portfolio Today">
     
    <meta name="viewport" content="width=device-width, initial-scale=1, shrink-to-fit=no">
    
    <meta name="description" content="itsfolio is for everyone,Create your portfolio website at your fingertips today .No coding or designing skills required.">
    
    <meta name="keywords" content="itsfolio, itsfolio folio">
    ...
    <title>itsfolio.com: Portfolio Website Builder- Create a Free Portfolio Today</title>
    
    <!--====== Favicon Icon ======-->
    
    <link type="image/x-icon" href="{{asset('assets/front/img/'.$bs->favicon)}}" rel="icon"> 
